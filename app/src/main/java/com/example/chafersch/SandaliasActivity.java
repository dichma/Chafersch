...
public class SandaliasActivity extends AppCompatActivity {
    ...
    private AdapterSandalias adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sandalias_layout);

        // Obtener la referencia del RecyclerView y establecer el adaptador
        RecyclerView recyclerView = findViewById(R.id.RecyclerViewSandalias);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new AdapterSandalias(this, zapatillaList);
        ...
        db.collection("Zapatillas")
                .whereEqualTo("Id_Categoria", "Sandalias")
                .get()
