...
public class OfertasActivity extends AppCompatActivity {
    ...
    private AdapterOfertas adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = findViewById(R.id.RecyclerViewOfertas);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new AdapterOfertas(this, zapatillaList);
        ...
        db.collection("Zapatillas")
                .whereEqualTo("Id_Categoria", "Ofertas")
                .get()
